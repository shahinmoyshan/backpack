<div x-on:click="changeTab('custom')"
    class="flex justify-between items-center px-6 py-4 border-b border-primary-200 cursor-pointer">
    ...
    <div class="px-6 py-4">
        <div class="mb-4">
            ...
            <input type="text" id="title" x-model="menuItemModel.title"
                class="block w-full py-2 px-3 rounded-md border border-primary-300 shadow-xs focus:border-accent-300 focus:ring-3 focus:ring-accent-200/50">
        </div>
        <div class="mb-4">
        ...
        <div class="flex justify-end">
            <button x-on:click="addMenuItem()"
                class="px-4 py-2 font-medium text-white transition-colors duration-300 text-[0.8rem] transform bg-accent-600 rounded-sm hover:bg-accent-500 focus:outline-hidden focus:ring-3 focus:ring-accent-300/80">
