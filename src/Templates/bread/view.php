<section
    ...
    // Include details partial
    if (isset($bread->getConfig('partials_inc', [])['details'])) {
        echo $bread->partial($bread->getConfig('partials_inc', [])['details'], ['bread' => $bread]);
    } else {
        echo $bread->partial(__DIR__ . '/inc/details', ['bread' => $bread]);
    }
